...
#define CAN_SPAM_TIMER_IRQ TIM3_IRQn
#define CAN_SPAM_TIMER TIM3

#define ISOTP_TIMER_IRQ TIM23_IRQn
#define ISOTP_TIMER TIM23
...
#if !defined(BOOTSTUB) || defined(BOOTSTUB_DEBUG)
