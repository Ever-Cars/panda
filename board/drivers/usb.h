  ...
  */
  ...
  switch (setup.b.bRequest) {
    case USB_REQ_SET_CONFIGURATION:
      ...
      USBx_OUTEP(3U)->DOEPTSIZ = (USB_BULK_MULTIPACKET_TRANSFER_MAX_PACKETS << 19) | USB_BULK_MULTIPACKET_TRANSFER_SIZE;
      ...
      USBx_OUTEP(5U)->DOEPTSIZ = (ISOTP_USB_BULK_TRANSFER_MAX_PACKETS << 19) | ISOTP_USB_BULK_TRANSFER_SIZE;
...
void usb_irqhandler(void) {
  ...
  if ((gintsts & USB_OTG_GINTSTS_OEPINT) != 0U) {
    ...
    if ((USBx_OUTEP(5U)->DOEPINT & USB_OTG_DOEPINT_XFRC) != 0U) {
      #ifdef DEBUG_USB
        print("  OUT5 PACKET XFRC\n");
      #endif
      // NAK cleared by isotp_tx_comms_resume_usb (if the write buffer has room)
