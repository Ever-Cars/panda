/**
  ******************************************************************************
  * @file    LwIP/richie-ethernet/src/main.c
...
int main(void)
{
  ...
  print("richie-ethernet booted v" APP_VERSION "\n");
  /* Configure the LCD ...*/
  BSP_Config();
  ...
  tcp_echoserver_init();
  print("TCP echo server initialized\n");
...
static void BSP_Config(void)
{
  print("  State: Ethernet Initialization ...\n");
  BSP_LEDs_Init();
}
